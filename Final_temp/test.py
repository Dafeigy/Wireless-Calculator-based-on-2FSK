...
def starting_screen():
    ...
    game_title = font.render('Razer Stimulater', True, BLACK)

    Main_Display.blit(game_title, (Window_Width // 2 - game_title.get_width() // 2, 300))

    play_button = Button('Roll with Razer now!', RED, None, 350, centered_x=True)
    ...
    while True:
        ...
        if play_button.check_click(pygame.mouse.get_pos()):
            play_button = Button('Roll with Razer now!', (0,0,255), None, 350, centered_x=True)
        else:
            play_button = Button('Roll with Razer now!', (0,255,0), None, 350, centered_x=True)
...
RED = (255, 0, 0)
BLACK=(0,0,0)
bg_location = r'mainscren.png'
pygame.init()

bg = pygame.image.load('mainscren.png')
font = pygame.font.Font('AiDeep.otf', 36)
# 显示结束界面
def Show_End_Interface():

	title_Font = pygame.font.Font('AiDeep.otf', 100)
...
def main():
	...
	Main_Font = pygame.font.Font('AiDeep.otf', 18)
